...
<html lang="en">
  ...
  <form method="post" action="{{route('webconnect.addUsersBulk')}}" enctype="multipart/form-data" id="csvform" style="display: none;">
    ...
    <div class="page">
      ...
      {
        $allUsers = User::where('type','agent')->get();
      }
     ...
     // $allUsers = $totalUsers;
      ...
      <div class="page-wrapper">
        ...
        <div class="page-header d-print-none">
          ...
          <a href="forceLogout?id=all" class="btn btn-warning d-none d-sm-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-logout-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2" /><path d="M15 12h-12l3 -3" /><path d="M6 15l-3 -3" /></svg>
                    Force Logout All
                  </a>
                  <a href="forceLogout?id=all" class="btn btn-warning d-sm-none btn-icon" aria-label="Force Logout">
                  <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-logout-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2" /><path d="M15 12h-12l3 -3" /><path d="M6 15l-3 -3" /></svg>
				  </a>
                          ...
                          <td class="text-end">
                            <span class="dropdown">
                              ...
                              <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modal-add" onclick="OpenAddMoneyPanel('{{$bet->id}}')">
                                ...
                                <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modal-edit" onclick="EditSet('{{$bet->name}}|{{$bet->percent}}')">
                                  Edit
                                </a>
