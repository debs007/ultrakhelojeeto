  ...
  <body >
    ...
    <div class="page">
      ...
      @php
        ...
        use App\Models\User;
        $allRequests = Message::select('*')->orderBy('created_at','desc')->get();
        @endphp
          ...
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                ...
                <div class="text-secondary mt-1">{{count($allRequests)}} messages</div>
              </div>
              <!-- Page title actions -->
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th><button class="table-sort" data-sort="sort-type">Message</button></th>
                        <th><button class="table-sort" data-sort="sort-score">Date</button></th>
                    ...
                    <tbody class="table-tbody">
                        ...
                        <td class="sort-type">{{$ar->message}}</td>
                        <td class="sort-score">{{explode('T',$ar->created_at)[0]}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                  </table>
