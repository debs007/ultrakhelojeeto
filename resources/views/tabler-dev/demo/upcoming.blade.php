    ...
    <div class="page">
      ...
      <div class="page-wrapper">
          ...
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                ...
                <div class="text-secondary mt-1">{{count($allUsers)}} Super Stockists</div>
              </div>
              <!-- Page title actions -->
        ...
        &nbsp;&nbsp;
                  ...
                  <a href="#" class="btn btn-success d-sm-none btn-icon" aria-label="Add csv" onclick="AfterSelectcsv()">
                    ...
                    <table class="table card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="pastEvents?fetch={{$bet->name}}">{{$bet->name}}</a></td>
                          <td>
                          ₹ {{$bet->balance}}
                          </td>
                          <td>
                            @if($bet->stockist == "default")
                            Admin
                            @else
                            {{$bet->stockist}}
                          @endif
