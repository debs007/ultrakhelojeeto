...
<div class="modal modal-blur fade" id="modal-user" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <form name="event_form" method="post" action="{{route('webconnect.createUser')}}" enctype="multipart/form-data">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">New Stockist</h5>
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="type" value="stockist" />
          </div>
          <div class="modal-body">
            <div class="row">
      ...
      if(Session::has('super'))
          $professions = User::where('name',Session::get('super'))->get();
      else
          $professions = User::where('type','super')->orderBy('name','asc')->get();
              @endphp
              <div class="col-lg-12">
...
<div class="modal modal-blur fade" id="modal-edit" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <form name="event_form" method="post" action="{{route('webconnect.editUser')}}" enctype="multipart/form-data">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Edit Stockist</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          ...
          <div class="modal-body">
            <div class="mb-3">
              <label class="form-label">Stockist name</label>
              <input type="text" class="form-control" name="name" id="editName" placeholder="Enter stockist's name" autocomplete="off" value="" required>
            </div>
